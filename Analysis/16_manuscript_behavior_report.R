...
output_index <- tribble(
  ...
  "22", "Repeated cage-change acute Active GAMM", "10min", "pipeline output group", "analysis_ready/pipeline/22_repeated_cagechange_acute_gamm/10min/", "Analysis/22_repeated_cagechange_acute_gamm.R", "primary manuscript evidence", "canonical", NA_character_, "Owns CLAIM_GAMM_04/05.", "manual",
  "23", "First Inactive Markov GAMM", "10min", "pipeline output group", "analysis_ready/pipeline/23_first_inactive_gamm/10min/", "Analysis/23_first_inactive_gamm.R", "extended data", "canonical", NA_character_, "Owns CLAIM_GAMM_06. Superseded Gaussian-log1p variants are retained under audit/gaussian_log1p_invalid/ and must never be quoted.", "manual",
