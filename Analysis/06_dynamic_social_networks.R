...
#   B) dyadic table generated by Analysis/02_build_dyadic_rfid_contacts.R
...
# True dyadic RFID contact file generated by Analysis/02_build_dyadic_rfid_contacts.R.
...
write_output_manifest(
  output_dir,
  script_name = "06_dynamic_social_networks.R",
...
if (!is.null(dyad_file) && file.exists(dyad_file)) {
  ...
  message("Run Analysis/02_build_dyadic_rfid_contacts.R first to enable true graph metrics.")
